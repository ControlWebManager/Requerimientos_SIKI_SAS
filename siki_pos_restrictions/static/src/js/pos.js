odoo.define('siki_pos_restrictions.pos', function (require) {
    "use strict";
    ...
    screens.NumpadWidget.include({
        ...
        var mode = this.state.get('mode');
            ...
            if (mode === 'discount' || mode === 'price'){
                ...
                self.gui.sudo_custom_siki({
                    'title': _t('Necesitas la Aprobación de un Supervisor'),
                    'special_group': this.pos.config.restrictions_pos_group_id[0],
    ...
    gui.Gui.include({
        ...
        sudo_custom_siki: function(options) {
